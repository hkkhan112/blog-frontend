  ...
  return (
    <Container>
         ...
         {/* <Ul> */}
               ...
               <a className='link' href="http://hamzakhan112.ga" target="blank"> <Li onClick={()=>setMenu(false)}> <InfoOutlinedIcon className='navbar-icons' fontSize='large'  />About</Li></a>
                {
                    user &&
               ...
               <Link className='link' to="/contact"> <Li onClick={()=>setMenu(false)}> <ContactMailOutlinedIcon className='navbar-icons' fontSize='large'  />Contact</Li>    </Link>
               {
                   user ?
