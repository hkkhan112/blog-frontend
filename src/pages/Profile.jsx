...
uploadTask.on('state_changed', 
  ...
  () => {
    getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
      ...
      const uploadFile = async ()=>{
        ...
        try {
            ...
            const res =  await axios.put('https://dead-pink-gazelle-wear.cyclic.app/api/users/'+user._id, updatedUser)
            setSuccess(true)
    ...
    <Form onSubmit={handleSubmit}>
        ...
        <UpdateButton type='submit'>{isFetching ? <CircularProgress /> : "Update"}</UpdateButton>
        {
            success &&
